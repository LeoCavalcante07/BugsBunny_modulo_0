                    ...
                    <form action="faleConosco.php" method="get">
                        ...
                        <div class="caixa_form_esquerda">
                            ...
                            <div class="caixa_form_esquerda_inputs">
                                 <p><input type="text" name="txtNome" onkeyup="validar(this, 'nome')"></p>
                                
                                <p><input type="tel" name="txtTel" placeholder="ex: (ddd)xxxx-xxxx" onkeyup="validar(this, 'tel')" maxlength="14"></p>
                                
                                <p><input type="tel" name="txtCel" placeholder="ex: (ddd)xxxxx-xxxx" onkeyup="validar(this, 'cel')" maxlength="15"></p>
                                
                                <p><input type="email" name="txtEmail" placeholder="ex: nome@gmail.com"></p>

                                <p><input type="radio" name="rdoSexo" value="m">Masculino</p>
                        ...
                        <div class="caixa_form_direita">
                            ...
                            <div class="caixa_form_direita_inputs">
                                 <p><input type="text" name="txtProfissao" onkeyup="validar(this, 'nome')"></p>
